      ...
      <footer className="relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="HeroTopImagenes/Logo/logo.png"
                    alt="logo"
                ...
                "Porque detrás de cada coleccionista hay 
                un niño que nunca dejó de creer en héroes"
                </p>
            ...
            <LinkGroup header="Nosotros">
              <NavLink link="/#" label="Historia " />
              <NavLink link="/#" label="Política de privacidad" />
 
            </LinkGroup>
            <LinkGroup header="Horarios ">
              <NavLink link="/#" label="Lunes a viernes  " />
              <NavLink link="/#" label="10:00 a 7:00" />
              <NavLink link="/#" label="Sabados" />
              <NavLink link="/#" label="1:00 a 7:00" />
            </LinkGroup>
            <LinkGroup header="contactanos">
              <NavLink link="/#" label="Cel, 67543456 " />
              <NavLink link="/#" label="contact@herotocollection.com" />
